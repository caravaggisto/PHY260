'''
TODO: don't rely on this class. Use numpy! Figure out how to 
do all the same stuff in numpy. It will be worth it... :)
'''

'''
Author: Igor Volobouev (i.volobouev@ttu.edu)
'''
...
class V3( object ):
    ...
    def __init__( self, x = 0.0, y = 0.0, z = 0.0 ):
        # Use float for internal representation.
        # This avoids various problems with integer division.
        self.x = x * 1.0
        self.y = y * 1.0
        self.z = z * 1.0
    ...
    def direction( self ):
        "Direction of the vector as a 3d vector with unit length."
        if ( self.__nonzero__() ):
    ...
    def __div__( self, other ):
        if ( other == 0.0 ):
            raise ZeroDivisionError, "3d vector divided by zero"
        return V3( self.x / other, self.y / other, self.z / other )
